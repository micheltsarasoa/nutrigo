---
name: cut-release
description: Ship the NutriGo sprint release by checking readiness, reviewing the release-please PR, running the restore drill (from Sprint 4) and merging to tag, publish and deploy. Use at the end of each sprint or for a hotfix release.
---
...
3. From Sprint 4: run the restore drill (restore the latest backup locally, then `npm run test:e2e:smoke`) and report the result.
